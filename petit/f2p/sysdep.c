...
set_tmp_names()
{
	...
	sprintf(c_functions, "%sf2p_func", t);
	sprintf(initfname, "%sf2p_rd", t);
	sprintf(blkdfname, "%sf2p_blkd", t);
	sprintf(p1_file, "%sf2p_p1f", t);
	sprintf(p1_bakfile, "%sf2p_p1fb", t);
	sprintf(sortfname, "%sf2p_sort", t);
#else
	int pid = getpid();
	sprintf(c_functions, "%s/f2p%d_func", tmpdir, pid);
	sprintf(initfname, "%s/f2p%d_rd", tmpdir, pid);
	sprintf(blkdfname, "%s/f2p%d_blkd", tmpdir, pid);
	sprintf(p1_file, "%s/f2p%d_p1f", tmpdir, pid);
	sprintf(p1_bakfile, "%s/f2p%d_p1fb", tmpdir, pid);
	sprintf(sortfname, "%s/f2p%d_sort", tmpdir, pid);
#endif
